<template>
  <AppLayout title="Empresa Editar">
      ...
      <div class="shadow-md sm:rounded-lg px-8 py-6  my-12 bg-white">
        ...
        <form @submit.prevent="submit">
          ...
          <div class="flex justify-end pb-2">
            <LinkButtonRed method="delete" :href="route('empresas.destroy', empresa.id)">
          ...
          <div class="flex justify-end mt-4">
            ...
            <JetButton class="ml-4 py-2.5" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
              <i class="fa-solid fa-plus pr-1"></i> Editar Empresa
            </JetButton>
          </div>
...
export default {
  ...
  data() {
    return {
      form: {
        ruc: this.$inertia.page.props.empresa.ruc,
        razon_social: this.$inertia.page.props.empresa.razon_social,
        razon_comercial: this.$inertia.page.props.empresa.razon_comercial,
        direccion: this.$inertia.page.props.empresa.direccion,
        responsable: this.$inertia.page.props.empresa.responsable,
        telefono: this.$inertia.page.props.empresa.telefono,
        celular: this.$inertia.page.props.empresa.celular,
        ubigeo: this.$inertia.page.props.empresa.ubigeo
      },
    }
  },
  methods: {
    submit: function () {
      this.$inertia.put(
        route("empresas.update", this.$props.empresa.id),this.form
      );
    }
  }
