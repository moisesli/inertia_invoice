      ...
      <div class="max-w-4xl mx-auto">
         <div class="shadow-md sm:rounded-lg py-1 my-10 bg-white">
            ...
            <div class="flex justify-between items-center">
               ...
               <div class="px-6">
                  <LinkBlue :href="route('clientes.create')">
                     <i class="fa-solid fa-plus pr-1"></i> Cliente
                  </LinkBlue>
               </div>
            </div>
            ...
            <table class="w-full my-2 text-sm text-left text-gray-500 sm:rounded-lg">
               ...
               <tbody>
                  <tr v-for="(cliente, index) in clientes.data" class="bg-white border-b hover:bg-gray-50">
                     <td class="w-4 pl-6">
                        {{ cliente.id }}
                     </td>
...
export default {
   ...
   methods: {
      search: _.throttle(function () {
         let url = this.route('clientes.index', {busq: this.busq});
